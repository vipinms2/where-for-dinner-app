...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","rabbitMQName":"rmq-where-for-dinner","dbType":"h2","devDefaultAccountPassword":"$2a$10$J/EWz6Q8zxRHYCr2UwJewe5hN6uKhbytUuGGC2yHvEJ2zhH.dLvZe","appSSOIssuerURI":"http://authserver.<domainname>","interfaceType":"http","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","numRabbitMQClusterNodes":1,"createResourceClaim":true,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input14999491778940363309, --data-values-file, /tmp/accelerator-options688535694476103747.json, --output-files, /tmp/ytt-output5780428997346598470]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","rabbitMQName":"rmq-where-for-dinner","dbType":"h2","devDefaultAccountPassword":"$2a$10$J/EWz6Q8zxRHYCr2UwJewe5hN6uKhbytUuGGC2yHvEJ2zhH.dLvZe","appSSOIssuerURI":"http://authserver.<domainname>","interfaceType":"http","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","numRabbitMQClusterNodes":1,"createResourceClaim":true,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input7974805445043066483, --data-values-file, /tmp/accelerator-options15653034340893001331.json, --output-files, /tmp/ytt-output13241606304181416630]
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"devDefaultAccountUsername":"where-for-dinner","artifactVersion":"0.0.1-beta","dbName":"db-where-for-dinner","rabbitMQName":"rmq-where-for-dinner","dbType":"h2","devDefaultAccountPassword":"$2a$10$J/EWz6Q8zxRHYCr2UwJewe5hN6uKhbytUuGGC2yHvEJ2zhH.dLvZe","appSSOIssuerURI":"http://authserver.<domainname>","interfaceType":"http","enableSecurity":false,"createRabbitMQCluster":true,"appSSOName":"appsso-where-for-dinner","numRabbitMQClusterNodes":1,"createResourceClaim":true,"enableDefaultDevAccount":true,"artifactId":"where-for-dinner","createDBInstance":true,"serviceNamespace":"service-instances","projectName":"where-for-dinner","workloadNamespace":"workloads","appSSORedirectURI":"http://where-for-dinner.<domain name>/login/oauth2/code/sso"}
┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input3431546067135875081, --data-values-file, /tmp/accelerator-options16814068219473969190.json, --output-files, /tmp/ytt-output10202688589861760841]
